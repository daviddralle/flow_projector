...
def main():
    ...
    st.markdown('<small><a href="https://github.com/daviddralle/flow_projector/blob/main/README.md" target="_blank">More details in the GitHub README</a> | <a href="https://github.com/daviddralle/flow_projector/blob/main/methods.md" target="_blank">View Methods Document</a></small>', unsafe_allow_html=True)
